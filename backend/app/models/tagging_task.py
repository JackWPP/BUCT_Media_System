...
class TaggingTaskItem(Base):
    ...
    submitted_title = Column(String(200))
    submitted_author = Column(String(100))
    original_classifications = Column(JSON)
    submitted_classifications = Column(JSON)
    draft_title = Column(String(200))
    draft_author = Column(String(100))
    draft_tags = Column(JSON)
    draft_classifications = Column(JSON)
