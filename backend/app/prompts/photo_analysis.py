...
Usage:
    ...
    prompt = get_prompt("v5", context={"photo_type": "风光类", "gallery_year": "2020年第三届获奖作品"})
"""
...
- 若记录事件/活动过程→纪实类，若以自然或建筑为主→风光类；不要输出人像作为受控分类
...
- gallery_series: 昌平校区摄影大赛、师生投稿
- gallery_year: 2018年第一届获奖作品、2019年第二届获奖作品、2020年第三届获奖作品、2021年第四届获奖作品、2022年第五届获奖作品、2023年第六届获奖作品、2024年第七届获奖作品、2025年第八届获奖作品
...
示例1（校园风光-秋季图书馆）：
{
  ...
  "classifications": {
    ...
    "gallery_series": "师生投稿", "gallery_year": null, "award_level": null,
    "photo_type": "风光类", "documentary_topic": null
  },
...
示例2（纪实活动-实验课）：
{
  ...
  "classifications": {
    ...
    "gallery_series": "师生投稿", "gallery_year": null, "award_level": null,
    "photo_type": "纪实类", "documentary_topic": "智育"
  },
...
{{
  ...
  "classifications": {{
    ...
    "award_level": null, "photo_type": "风光类", "documentary_topic": null
  }},
  "free_tags": ["柳湖", "樱花", "倒影", "水面", "教学楼", "春景"],
  "quality_flags": [],
  "risk_flags": [],
...
{{
  ...
  "classifications": {{
    "season": null, "campus": "昌平校区", "landmark": "实验楼",
    "gallery_series": "昌平校区摄影大赛", "gallery_year": "{gallery_year}",
    "award_level": null, "photo_type": "纪实类", "documentary_topic": "智育"
  }},
  "free_tags": ["化学实验", "实验课", "学生", "实验服"],
  "quality_flags": [],
  "risk_flags": ["含人物"],
...
def get_prompt(version: str = "v5", context: dict[str, Any] | None = None) -> str:
    ...
    if is_contest:
        ...
        if contest_key in PROMPTS:
            ...
            photo_type = context.get("photo_type", "风光类")
